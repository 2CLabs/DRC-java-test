...
public class IDREvidence extends Contract {
    ...
    public Tuple6<String, String, List<String>, List<String>, List<String>, Boolean>
            getDataRightEvidenceViaEid(String udri) throws ContractException {
        final Function function =
                new Function(
    ...
    public Tuple3<Boolean, List<String>, List<String>> getReviewEvidenceViaEid(String eid)
            throws ContractException {
        final Function function =
                new Function(
