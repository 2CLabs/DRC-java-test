...
public class IDREvidence extends Contract {
    ...
    public Tuple2<Boolean, String> checkAccount(String account) throws ContractException {
        final Function function =
                new Function(
                        FUNC_CHECKACCOUNT,
                        Arrays.<Type>asList(
    ...
    public String getUserAccount(String bid) throws ContractException {
        final Function function =
                new Function(
                        FUNC_GETUSERACCOUNT,
                        Arrays.<Type>asList(
